...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insertar el Requerimiento de Capacitación en la base de datos
    $stmt = $conn->prepare("INSERT INTO sg_omil_requerimientos_capacitacion (UsuarioID, Descripcion, FechaSolicitud) VALUES (?, ?, ?)");
    $stmt->bind_param("iss", $usuario_id, $descripcion, $fecha_solicitud);

    if ($stmt->execute()) {
        echo "Requerimiento de Capacitación registrado con éxito.";
    } else {
        echo "Error al registrar el Requerimiento de Capacitación: " . $stmt->error;
    }
...
<head>
    ...
    <title>Registrar Requerimiento de Capacitación</title>
    <link rel="stylesheet" type="text/css" href="styles.css">
</head>
<body>
    <h2>Registrar Requerimiento de Capacitación</h2>
    <form method="POST" action="registrar_requerimiento_capacitacion.php">
        ...
        <input type="submit" value="Registrar Requerimiento de Capacitación">
    </form>
